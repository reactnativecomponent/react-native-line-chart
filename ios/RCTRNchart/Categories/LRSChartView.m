...
-(void)addLeftBezierPoint{
    ...
    gradientLayer.colors = @[(__bridge id)[UIColor colorWithHexString:_layerColor andAlpha:0.2].CGColor,(__bridge id)[UIColor colorWithHexString:_layerColor andAlpha:0.0].CGColor];
